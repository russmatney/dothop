...
var obj_scene_override = {
	"Player": preload("res://src/themes/dots/Player.tscn"),
	"Dot": preload("res://src/themes/dots/Dot.tscn"),
	"Dotted": preload("res://src/themes/dots/Dot.tscn"),
	"Goal": preload("res://src/themes/dots/Dot.tscn"),
	}
